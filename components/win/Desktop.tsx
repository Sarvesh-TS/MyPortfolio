    ...
    >
      ...
      <a
        ...
        style={{
          ...
          boxShadow: "0 4px 16px rgba(37,211,102,0.45), 0 2px 6px rgba(0,0,0,0.35)",
          zIndex: 60,
          transition: "transform 120ms ease, box-shadow 120ms ease",
          textDecoration: "none",
        }}
        onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = "scale(1.1)"; (e.currentTarget as HTMLElement).style.boxShadow = "0 6px 22px rgba(37,211,102,0.6), 0 2px 6px rgba(0,0,0,0.35)" }}
        onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = ""; (e.currentTarget as HTMLElement).style.boxShadow = "0 4px 16px rgba(37,211,102,0.45), 0 2px 6px rgba(0,0,0,0.35)" }}
      >
