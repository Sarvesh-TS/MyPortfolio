...
export function StartMenu() {
  ...
  return (
    <AnimatePresence>
      {startOpen && (
        <>
          <div style={{ position:"fixed", inset:0, zIndex:8800 }} onClick={closeStart} />
          <motion.div
          ...
          >
            ...
            <div className="start-footer mica">
              ...
              <button className="btn-subtle" style={{ fontSize:12, padding:"4px 14px", display:"flex", alignItems:"center", gap:6 }}>
